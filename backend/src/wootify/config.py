...
from wootify.paths import DEFAULT_DATABASE_PATH, DEFAULT_INSTAGRAM_SESSION_DIR, DEFAULT_LOG_PATH, PROJECT_ROOT, VAR_ROOT

repo_root = PROJECT_ROOT
default_sqlite_database_url = f"sqlite:///{DEFAULT_DATABASE_PATH.as_posix()}"
...
class Settings(BaseSettings):
    ...
    WOOTIFY_VAR_DIR: str = str(VAR_ROOT)
    ...
    INSTAGRAM_PV_SESSION_DIR: str = str(DEFAULT_INSTAGRAM_SESSION_DIR)
    ...
    LOG_FILE_PATH: str = str(DEFAULT_LOG_PATH)
