...
from wootify.infrastructure.persistence.repositories.conversation_repository import ConversationRepository
from wootify.infrastructure.persistence.repositories.message_mapping_repository import MessageMappingRepository
...
class HttpApplicationServices:
    """Shared service composition used by all HTTP endpoint handlers.

    The legacy aliases below intentionally remain available for imports and
    monkeypatches, while construction is centralized in one object.
    """
...
bridge = http_services.bridge
enterprise = http_services.enterprise
enterprise_telegram = http_services.enterprise_telegram
enterprise_documents = http_services.enterprise_documents
