...
from wootify.db import SessionLocal
from wootify import runtime_registry
from wootify.models import InboundEventRetry, Instance
...
class BalePollingService:
    ...
    def __init__(self) -> None:
        ...
        self._temp_sms_dump_path = DEFAULT_ENTERPRISE_TMP_DIR / 'sms-sync-results.jsonl'
