...
from wootify.config import repo_root, settings
from wootify.paths import DEFAULT_ENTERPRISE_ASSET_DIR
from wootify.models import Instance, InstanceFeatureOverride, PlatformType
from wootify.repositories.feature_repository import FeatureRepository
from wootify.repositories.instance_repository import InstanceRepository
from wootify.repositories.platform_repository import PlatformRepository
from wootify.repositories.runtime_state_repository import RuntimeStateRepository
from wootify.schemas.api_v1 import FeatureOverrideResponse, InstanceCreateRequest, InstancePatchRequest, InstanceResponse
from wootify.utils.cache_utils import TTLCache
from wootify.utils.crypto_utils import encryptor
from wootify.utils.payload_utils import mask_secret
...
class InstanceService:
    ...
    def delete_instance(self, db: Session, instance_key: str) -> bool:
        ...
        try:
            ...
            if not row:
                return False
            asset_dir = DEFAULT_ENTERPRISE_ASSET_DIR / str(row.instance_key).strip()
