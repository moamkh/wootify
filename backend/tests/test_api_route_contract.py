...
EXPECTED_ROUTES = {
    ...
    for method, path in {
        ...
        ("POST", "/api/v1/instances/{instance_key}/eitaa-pv/auth/send-code"),
        ("POST", "/api/v1/instances/{instance_key}/eitaa-pv/auth/validate-code"),
        ("GET", "/api/v1/instances/{instance_key}/eitaa-pv/auth/status"),
