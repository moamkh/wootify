...
from wootify.models import Base, Instance
from wootify.utils.crypto_utils import JsonEncryptor
...
def test_dev_fallback_sentinel_resolves_to_dev_key():
    from wootify.utils.crypto_utils import DEV_FALLBACK_SENTINEL, _development_fallback_key
